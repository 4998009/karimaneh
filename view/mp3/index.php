    ...
    <div class="row box">
        ...
        <div class="col-md-6 col-sm-10">
            ...
            <div class="postInfo">
                ...
                <small class="ml-3" id="tracktime">زمان   <?=$item['regTime'] ?></small>
        ...
        <div class="col-md-4 col-sm-10">
            <audio controls preload="metadata" ontimeupdate="document.getElementById('tracktime').innerHTML = Math.floor(this.currentTime) + ' / ' + Math.floor(this.duration);">
